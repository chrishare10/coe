...
$(function() {
  ...
  newsletterModal.addEventListener("click", function(event) {
      ...
      if ( event.target.matches("#modal-exit") || !event.target.closest("#mc_embed_signup")) {
  ...
  // three col scrolltrigger


    var columns = gsap.utils.toArray('.three-col-content');
